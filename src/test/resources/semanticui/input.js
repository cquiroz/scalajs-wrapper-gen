...
var Input = (_temp = _class = function (_React$Component) {
    ...
    _createClass(Input, [{
        ...
        value: function renderText() {
            ...
            var other = _objectWithoutProperties(_props, ['action', 'children', 'className', 'defaultClasses', 'icon', 'fluid', 'focus', 'inverted', 'labeled', 'loading', 'name', 'placeholder', 'size', 'state', 'transparent']);
        ...
        value: function processChildren() {
            ...
            _react2.default.Children.forEach(this.props.children, function (child) {
                ...
                } else if (child.type === _elements.Button && typeof child.type !== 'undefined') {
